...
Before you send a reminder, understand why it happens:
...
The fifth is a conversation starter, not a reason to get angry.

## The timing: when to send your first reminder

Here's the rule: **send a friendly reminder one day *before* the due date.**

Why? Because most people forget. A day before puts it on their radar *before* it's late, which means they can arrange payment without scrambling or excuses. It feels helpful, not accusatory.
...
- Frames it as helpful ("heads-up") not demanding
- Includes the invoice number for clarity
- Gives them a chance to pay before they're late

Most clients who miss deadlines will pay within 24 hours of this message.

## If it passes the due date: the second reminder

If payment doesn't arrive by the due date, send a second message, but **not the same day.** Wait 2-3 days. This gives them time to see the first message, arrange payment, and possibly beat you to it.
...
- Assumes good faith ("no rush if there's a delay")
- Gives them an easy out if there's a legitimate reason
- Asks for clarity, not payment (subtly, this is less confrontational)

Most clients pay after this message.
...
> "Hi [Client name], I'm following up on invoice INV-014, which is now 10 days overdue. I need to close this out. Can you send payment by [specific date 2 days out]? If there's an issue preventing payment, let me know and we can work it out. My account details are below."

**What this does:**
- States the situation clearly
- Sets a firm but reasonable deadline
- Opens a door to conversation if there's a real problem
- Reminds them of the payment method (removes friction)

Most clients pay within 2 days of this message.

## If they still don't pay: the reset
...
**These don't:**
- "You haven't paid yet" (accusatory)
- "As per my previous invoice" (cold, formal, sounds like you're annoyed)
- "This is now overdue and I need immediate payment" (creates defensiveness)
- Anything that implies they're being dishonest

The difference between the two sets is tone. One invites cooperation; the other invites resistance.

## Make it easier on yourself: track it
...
## The real secret: get it right from the start

The best way to avoid all of this? [Send a clear invoice with a firm due date](/blog/how-to-write-an-invoice-that-gets-paid), agree on payment terms upfront, and make paying you as frictionless as possible. Most late payments start with ambiguous terms or unclear payment details.
